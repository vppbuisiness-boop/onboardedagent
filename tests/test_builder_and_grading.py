...
def _seed(conn):
    recs = [
        _line("1", "P1", "TA", "TB", "gA", "MAP 1 Kills", 5.5, "2026-01-01T10:00:00Z"),
        _line("2", "P2", "TA", "TB", "gA", "MAP 1 Kills", 6.5, "2026-01-01T10:00:00Z"),
        _line("3", "P3", "TC", "TD", "gB", "MAP 1 Kills", 7.5, "2026-01-01T12:00:00Z"),
        _line("4", "P4", "TE", "TF", "gC", "MAPS 1-3 Kills", 20.5, "2026-01-01T14:00:00Z", map_to=3),
    ]
...
def test_open_line_tracking(tmp_path):
    ...
    upsert_lines(conn, [_line("9", "X", "A", "B", "g", "MAP 1 Kills", 4.5, "2026-01-01T10:00:00Z")], "2026-01-01T00:00:00Z")
    upsert_lines(conn, [_line("9", "X", "A", "B", "g", "MAP 1 Kills", 5.5, "2026-01-01T10:00:00Z")], "2026-01-01T00:05:00Z")
...
def test_grading_sums_maps_and_voids_short_series(tmp_path):
    ...
    rows.append(("dota", "t", "m1", "s1", 1, "2026-01-01T10:30:00Z", "L", None, None, "P1", "P1", "TA", "TB", "mid", "r", None, 7, 1, 1, None, 20, 10, 30.0, 1, 0))
    rows.append(("dota", "t", "m2", "s2", 1, "2026-01-01T14:30:00Z", "L", None, None, "P4", "P4", "TE", "TF", "mid", "r", None, 9, 1, 1, None, 20, 10, 30.0, 1, 0))
    rows.append(("dota", "t", "m3", "s2", 2, "2026-01-01T15:30:00Z", "L", None, None, "P4", "P4", "TE", "TF", "mid", "r", None, 8, 1, 1, None, 20, 10, 30.0, 1, 0))
    conn.executemany("INSERT INTO player_games VALUES (" + ",".join("?" * 25) + ")", rows)
    conn.commit()
    out = grade_lines(conn, "dota", "prizepicks", min_age_hours=0)
